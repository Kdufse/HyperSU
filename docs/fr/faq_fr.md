...
## Qu'est-ce qu'HyperSU ?

HyperSU est une méthode de root, similaire à Magisk ou KernelSU, offrant encore plus de fonctionnalités.

## Quelle est la différence entre HyperSU et Magisk ?

- Magisk modifie init, tandis qu'HyperSU patche le noyau Linux.

## Quelle est la différence entre HyperSU et KernelSU ?

- KernelSU nécessite le code source. HyperSU n'a besoin que du fichier boot.img.

## Quelle est la différence entre HyperSU, Magisk et KernelSU ?
...
## Relation entre HyperSU et KernelPatch

HyperSU dépend de KernelPatch, héritant de toutes ses fonctionnalités, et l'étendant.
...
- De plus, HyperSU fournit un support SELinux supplémentaire directement via magiskpolicy.  

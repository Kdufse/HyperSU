...
## Was ist HyperSU?
HyperSU ist eine Root-Lösung, ähnlich wie Magisk oder KernelSU, welche das Beste beider vereint.
...
## Was ist der Unterschied zwischen HyperSU und Magisk?
- Magisk modifiziert das Init-System mit einer Korrektur in Ihrem boot image ramdisk, während HyperSU den Kernel direkt korrigiert.


## HyperSU gegen KernelSU
- KernelSU benötigt den Quellcode für dein Geräte-Kernel, welcher nicht immer von der OEM gegeben wird. HyperSU funktioniert allein mit Ihrem Standard-`boot.img`.


## HyperSU gegen Magisk, KernelSU
- HyperSU erlaubt Ihnen, optional, nicht SELinux zu modifizieren, was bedeutet, dass ein App-Kontext gerootet werden kann, sodass libsu und IPC nicht benötigt werden.
...
## Beziehung zwischen HyperSU und KernelPatch

HyperSU benötigt KernelPatch, übernimmt all seine Fähigkeiten und wurde erweitert.
...
- KernelPatch bearbeitet den SELinux-Kontext nicht und umgeht den SELinux über einen Haken.
  ...
  Dies ist bequem.
- Dazu verwendet HyperSU direkt das Magiskkonzept, um weitere SELinux-Unterstützung bereitzustellen.
